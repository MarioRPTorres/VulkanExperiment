...
void main() {
    ...
    vec3 n = UnprojectPoint(p.x, p.y, 0.0, view.view, view.proj).xyz; // unprojecting on the near plane
    nearPoint = n;
    vec3 f = UnprojectPoint(p.x, p.y, 1.0, view.view, view.proj).xyz; // unprojecting on the far plane
    farPoint = f;
    near = n.z;
    far = f.z;
    fragView = view.view;
